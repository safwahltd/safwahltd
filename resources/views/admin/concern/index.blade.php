...
@section('body')
    <div class="page-header">
        <div>
            <h1 class="page-title">Concern</h1>
        </div>
                                                        ...
                                                        <div class="card-body">
                                                            <form class="form-horizontal" action="{{route('admin.concern.update',$concern->id )}}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row mb-4">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input class="form-control bg-transparent" required value="{{ $concern->serial }}" id="serialshow" name="serial" placeholder="Enter Serial Number" type="number">
