    ...
    <div class="container-fluid position-relative py-5 mb-5">
        <div class="container">
            <div class="text-center mx-auto pb-5" data-wow-delay=".3s" style="max-width: 600px;">
                <h1 class="mb-3">Request For Bulk Order</h1>
            </div>
            <div class="row justify-content-center g-5">
                ...
                <div class="col-lg-6" data-wow-delay=".3s">
                    <form action="{{route('bulk.order.submit')}}" method="post">
                        @csrf
                        <div class="p-5 rounded" style="background-color: {{$cms->bulk_order_form_color}}">
                            <div class="mb-4">
